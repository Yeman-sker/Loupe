import { has_no_known_camel_case_fields, has_optional_string, is_number, is_record, is_string_array, is_string_record } from "./wire-guards.js";
...
export function is_locator_status(value: unknown): value is LocatorStatus {
  return typeof value === "string" && locator_statuses.has(value);
}
...
export function is_frame_path(value: unknown): value is FrameLocatorPath {
  return (
    Array.isArray(value) &&
    value.every(
      (item) =>
...
export function is_boundary(value: unknown): value is TargetBoundary {
  return (
    is_record(value) &&
    has_no_known_camel_case_fields(value) &&
...
export function is_resolve_result(value: unknown): value is ResolveResult {
  ...
  if (!is_locator_status(value.locator_status)) return false;
